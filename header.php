...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <h1 class="logo"><a href="index.php">Tugas Portofolio</a></h1>
            ...
            <ul>
                ...
                <li class="dropdown"><a href="#"><span>My Project</span> <i class="bi bi-chevron-down"></i></a>
                    <ul>
                        ...
                        <li><a href="https://maldikurniawan.github.io/Tugas-7-JS/" target="_blank">suaraHewan.exe</a></li>
                        <li><a href="https://maldikurniawan.github.io/Tugas-4-JS/" target="_blank">loginForm.exe</a></li>
                        <li><a href="https://cerpenzako.000webhostapp.com/" target="_blank">CRUD Web</a></li>
                    </ul>
                </li>
